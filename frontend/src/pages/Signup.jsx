...
const Signup = () => {
  ...
  return (
    <div className="min-h-screen bg-[#232323] flex flex-col justify-center items-center">
      <div className="flex flex-col md:flex-row items-center justify-center gap-35 py-10 px-15">
        ...
        {/* Auth Card */}
        <div className="bg-[#18181B] rounded-xl shadow-lg shadow-black-100 p-8 w-[360px] md:w-[400px] px-10 ">
            ...
            {({ isSubmitting }) => (
              <Form>
                ...
                <button
                  ...
                  className="w-full bg-blue-600 text-white rounded-lg py-2 font-semibold mt-3 mb-3 hover:bg-blue-700 cursor-pointer"
                >
          ...
          <div className="flex justify-center">
            <span className="text-gray-400 text-sm">
              ...
              <Link to="/login" className="text-gray-200 hover:underline cursor-pointer">
                Log in
              </Link>
            </span>
          </div>
