        ...
        <div className="min-h-screen bg-[#232323] flex flex-col">
            <div className="flex-1 flex flex-col py-20 ml-7">
                ...
                <div className="flex flex-col justify-center items-center flex-1">
                    <div style={{fontFamily: 'Monaco, sans-serif'}} className="bg-[#2D2C2F] rounded-xl shadow-lg shadow-gray-700 p-0 w-[370px] flex flex-col items-center border-2 border-gray-700 mb-8">
