    ...
    <main className="min-h-screen bg-[#0f1115] text-white pt-28 pb-16 px-6 lg:px-12 font-['Montserrat']">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          <section className="w-full lg:w-80 rounded-3xl border border-white/5 bg-gradient-to-b from-[#151a22] to-[#0f1115] p-6 shadow-2xl shadow-black/30 space-y-6 lg:shrink-0">
            {/* Top Gainers */}
            <div>
            ...
            <div className="border-t border-white/10 pt-6">
              <div className="flex items-center justify-between mb-4">
                <p className="text-sm text-gray-300 font-medium">Top Losers</p>
              </div>
              {topLosers.length === 0 ? (
                <p className="text-xs text-gray-500">No losers available.</p>
              ) : (
                <ul className="space-y-3">
                  {topLosers.map((item) => (
                    <li
          ...
          <section className="flex-1 rounded-3xl border border-white/5 bg-[#11141b] p-6 shadow-inner shadow-black/30">
