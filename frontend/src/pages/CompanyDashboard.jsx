...
const CompanyDashboard = () => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-900 to-slate-900 text-gray-100 flex items-center justify-center pt-16">
        Loading…
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-slate-900 text-gray-100 pt-16 pb-10 font-sans">
      {/* HEADER */}
      <div className="max-w-6xl mx-auto bg-gradient-to-br from-gray-900/80 to-slate-900/90 rounded-b-3xl px-6 py-4 flex items-center justify-between shadow-[0_15px_30px_-5px_rgba(0,0,0,0.7)] border-b border-cyan-800/50">
        <div className="flex items-center gap-4">
          <div className="h-10 w-10 rounded-full bg-gradient-to-br from-cyan-400 to-blue-600 text-white flex items-center justify-center font-bold text-xl shadow-md">
      ...
      <div className="max-w-6xl mx-auto mt-6 bg-gray-900/70 rounded-3xl p-6 shadow-[0_0_50px_rgba(0,180,255,0.15)] border border-gray-700/50">
        ...
        <div className="flex justify-center gap-4 text-xs mb-4 text-gray-300">
          ...
          <span className="flex items-center gap-1">
            <span className="text-[#ef4444] text-lg">●</span> Financial Event
          </span>
          <span className="flex items-center gap-1">
            <span className="text-[#10b981] text-lg">●</span> Dividend
          </span>
        </div>
